...
?>
        ...
        <header class="bg-primary text-white text-center py-5" style="background: url('../public/img/hannah-morgan-ycvfts5ma4s-unsplash-2.jpg') no-repeat center center/cover; height: 70vh; background-position: center;">
            <div class="container">
