                                    ...
                                    <tbody>
                                        <?php foreach ($cartItems as $productId => $quantity): ?>
                                            ...
                                            <tr>
                                                <!-- Hình ảnh sản phẩm -->
                                                <td class="cart-pic">
                                                    <img src="/public/assets/admin/img/<?= htmlspecialchars($product['img']); ?>" alt="<?= htmlspecialchars($product['name']); ?>" style="max-width: 80px; max-height: 80px;">
                                                </td>
                                                <!-- Tên sản phẩm -->
                                                <td class="cart-title">
                                                ...
                                                <!-- Giá từng sản phẩm -->
                                                <td class="p-price"><?= number_format($product['product_price'], 0, ',', '.') . ' VNĐ'; ?></td>
                                                <!-- Số lượng sản phẩm -->
                                                <td class="qua-col">
                                                    <div class="quantity">
                                                        <div class="pro-qty">
                                                            <input type="number" value="<?= $quantity; ?>" min="1" data-product-id="<?= $productId; ?>">
                                                        </div>
                                                    </div>
                                                </td>
                                                <!-- Tổng giá từng dòng -->
                                                <td class="total-price"><?= number_format($totalItemPrice, 0, ',', '.') . ' VNĐ'; ?></td>
                                                <!-- Xóa sản phẩm -->
                                                <td class="close-td">
                                                    <a href="/cart/remove/<?= $productId; ?>" class="ti-close"></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                            ...
                            <div class="row">
                                <div class="col-lg-4 offset-lg-4">
                                    <div class="proceed-checkout">
                                        <ul>
                                            <li class="subtotal">Tạm tính <span><?= number_format($total, 0, ',', '.') . ' VNĐ'; ?></span></li>
                                            <li class="cart-total">Tổng cộng <span><?= number_format($total, 0, ',', '.') . ' VNĐ'; ?></span></li>
                                        </ul>
